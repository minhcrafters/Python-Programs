...
def move(current_position, velocity, lower_bound, upper_bound):
    current_position += velocity
    if current_position < lower_bound:
        current_position, velocity = lower_bound, -velocity
    if current_position > upper_bound - lower_bound:
        current_position, velocity = upper_bound - lower_bound, -velocity
